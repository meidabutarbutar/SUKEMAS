<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="filament js-focus-visible min-h-screen antialiased">
...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-gray-100">
        ...
        <!-- Footer -->
        <footer aria-labelledby="footer-heading" class="sticky top-[100vh]">
