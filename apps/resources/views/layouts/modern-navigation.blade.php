    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 justify-between">
            <div class="flex">
                ...
                <div class="hidden md:ml-12 md:flex md:space-x-8 tracking-wide text-lg">
                    ...
                    @if (skm_hasTenant())
                        <x-nav-link :href="route('public-report', [
                            'token' => skm_tenant()->tokenl,
                        ])" :active="request()->routeIs('public-report')">
                            {{ __('Statistik') }}
                        </x-nav-link>

                        <x-nav-link :href="route('survey', [
                            'token' => skm_tenant()->token,
            ...
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <a href="{{ route('tenant-selection') }}"
                        class="rounded-md bg-green-700 px-4 py-3 text-md font-semibold text-white shadow-sm hover:bg-green-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-300"
                        data-te-toggle="modal" data-te-target="#exampleModal">Instansi</a>
                </div>

                <div class="flex-shrink-0 ml-2">
                    <a href="{{ route('filament.auth.login') }}"
                        class="rounded-md bg-indigo-700 px-4 py-3 text-md font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400">{{ auth()->guest() ? 'Login' : 'Dashboard' }}
                        ></a>
                </div>
            </div>
        </div>
    ...
    <div x-description="Mobile menu, show/hide based on menu state." class="md:hidden" id="mobile-menu" x-show="open">
        ...
        <div class="border-t border-gray-200 pb-3 pt-4">
            ...
            <div class="mt-3 space-y-1">
                <a href="#"
                    class="block px-4 py-2 text-base font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-800 sm:px-6">Your
                    Profile</a>
                <a href="#"
